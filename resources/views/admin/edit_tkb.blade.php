        ...
        <div class="panel-body">
            ...
            <div class="position-center">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tengv" class="form-control" id="exampleInputEmail1" value="{{$cate->TenGV}}" required="true" readonly>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Thứ</label>
                    <input type="text" name="thu" class="form-control" id="exampleInputEmail1" value="{{$cate->Thu}}" required="true" readonly>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Từ Tiết</label>
                    <input type="text" name="tutiet" class="form-control" id="exampleInputEmail1" value="{{$cate->TuTiet}}" required="true" readonly>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Đến Tiết</label>
                    <input type="text" name="dentiet" class="form-control" id="exampleInputEmail1" value="{{$cate->DenTiet}}" required="true" readonly>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">SL</label>
                    <input type="text" name="sl" class="form-control" id="exampleInputEmail1" value="{{$cate->SoLuongSV}}" required="true" readonly>
                </div>
                <div class="form-group">
                ...
                <button type="submit" name="add_tkb" class="btn btn-info">Duyệt</button>
                </form>
                @endforeach
            </div>
